...
export function BrandPanelRegister({
  kicker = "PENCEGAHAN STUNTING DAN PEMANTAUAN GIZI",
  headline = "",
  tagline = "",
  heroImage = "/register-image.gif",
  ...
  return (
    <div className="relative hidden lg:flex flex-col bg-linear-to-br from-blue-600 via-blue-700 to-indigo-800 p-10 overflow-hidden">
      ...
      {/* Hero image / video — flush against bottom-right corner.
          object-cover + object-bottom-right memaksa konten visual rapat ke
          pojok kanan-bawah meskipun file GIF/video punya area kosong di dalamnya. */}
      <div className="pointer-events-none absolute -bottom-px -right-px z-0  w-[50%] max-w-md overflow-hidden">
        {isVideo ? (
          <video
            src={heroImage}
            autoPlay
